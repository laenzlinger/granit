// Generated by SolidPython <Unknown> on 2026-04-25 16:22:58
$fa = 0.4; $fs = 0.4;
...
rotate(a = 180, v = [1, 0, 0]) {
	difference() {
		scale(v = [1, 1, -1]) {
			difference() {
				linear_extrude(height = 1.4100000000) {
					offset(r = 1.0000000000) {
						import(file = "granit-stencil_3d_edge.dxf", origin = [0, 0]);
					}
				}
		...
		linear_extrude(center = true, height = 0.4800000000) {
			translate(v = [0, 0, 0]) {
				import(file = "granit-stencil_3d_top.dxf", origin = [0, 0]);
			}
		}
	}
}
